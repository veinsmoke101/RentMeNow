...
automatique.text = "Automatic";
automatique.value = "automatique";
const manuelle = document.createElement('option');
manuelle.text = "Manual";
manuelle.value = "manuelle";
...
type.addEventListener('change',() =>{
  ...
  formulaire.append(carburantLabel,carburant,dateContainer,submit);
